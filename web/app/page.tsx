      ...
      <section className="py-20">
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1 space-y-6">
            ...
            <Link href="/marketplace" className="inline-flex items-center gap-2 text-orange-600 font-bold hover:gap-3 transition-all">
      ...
      <section className="py-20 bg-orange-600 text-white text-center">
        <div className="container mx-auto px-6">
          ...
          <div className="flex justify-center gap-4">
            <Link href="/signup" className="bg-white text-orange-600 px-8 py-4 rounded-full font-bold hover:bg-gray-100 transition-colors">
              Get Started
            </Link>
            <Link href="/login" className="border-2 border-white px-8 py-4 rounded-full font-bold hover:bg-white/10 transition-colors">
              Login
            </Link>
          </div>
        </div>
